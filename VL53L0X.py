...
##
# @file VL53L0X.py
# This code was written by Robin Matzner and the source can
# be found at https://github.com/uceeatz/VL53L0X
#
# Our ME405 team made some minor modifications to make this work
# with a modern version of micropython.
...
class VL53L0X:
    ...
    def perform_single_ref_calibration(self, vhv_init_byte):
        ...
        while self._register((RESULT_INTERRUPT_STATUS & 0x07) == 0):
            time_elapsed = utime.ticks_diff(utime.ticks_ms(), start)
